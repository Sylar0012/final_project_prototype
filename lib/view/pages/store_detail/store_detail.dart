          ...
          Column(
            ...
            children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Color(0xFFFF521C), width: 1),
                          color: Colors.white,
                        ),
                        height: 160,
                        child: Padding(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  _bulidStoreCategory("메뉴"),
                  _bulidStoreCategory("정보"),
                  _bulidStoreCategory("리뷰"),
                ],
              ),
              Divider(
                height: 1,
      ...
      child: Row(
        children: [
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20),
              border: Border.all(color: Color(0xFFFF521C)),
            ),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(20),
              child: Image.asset(
